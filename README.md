...
## В ходе проекта:
- **Отлично прокачены навыки командной работы**
- **Разработаны и реализованы технические решения, позволяющие оптимизировать время выполнения операций и потребляемую память: использование разреженных матриц, обработка и заполнение данных батчами и т.п.**
