...
- **Прокачаны навыки оптимизации алгоритмов – разработаны и реализованы технические решения, также позволяющие значительно сократить время выполнения операций и объём памяти: использование множеств, применение векторизованных операций к массивам и датафреймам, обработка и заполнение данных батчами и другие**
